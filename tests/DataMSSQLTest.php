...
class DataMSSQLTest extends TestCase
{
    ...
    {
        $_ENV["DB_TRUSTSERVERCERTIFICATE"] = true;
        $this->DBA = new \Tina4\DataMSSQL("localhost/1433:master", "sa", "Tina1234!");
    }
    ...
    {
        $this->assertEquals("mssql", $this->DBA->getShortName());
    }

    final public function testGetDefaultPort(): void
    {
        $this->assertEquals(1433, $this->DBA->getDefaultDatabasePort());
    }
    ...
    final public function testDropCreateTable(): void
    {
        ...
        $this->DBA->exec("create table sub_testing (
            ...
            testing_id integer default 0 not null references testing(id) on delete cascade,
            primary key(id)
        )");
        $this->DBA->commit();
